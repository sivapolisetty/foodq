-- Drop and recreate with proper data types matching the database schema
DROP FUNCTION IF EXISTS get_nearby_deals(DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, INTEGER, UUID, TEXT);

-- Create function with exact data types that match database schema
...
RETURNS TABLE (
  ...
  allergen_info CHARACTER VARYING,
