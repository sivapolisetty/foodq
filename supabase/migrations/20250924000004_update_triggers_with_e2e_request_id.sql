-- Update trigger functions to support e2e_request_id from session variables
-- This allows the API to set the e2e_request_id before database operations

-- Create helper function to set session configuration
...
-- Update order event creation function to include e2e_request_id
