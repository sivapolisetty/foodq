...
-- Create a simple version that returns JSON to avoid type mismatches
  ...
  RETURN (
    SELECT json_agg(
      json_build_object(
        ...
        'business_owner_id', b.owner_id,
        'business_latitude', b.latitude,
        'business_longitude', b.longitude,
